...
root = "benchmark/No-Subfig-Img/train/"
...
class ImageCaptioningDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        encoding = self.processor(images=item["image"], text=item["RLHF_lower_case_caption"], padding="max_length",truncation=True, max_length=512, return_tensors="pt")
